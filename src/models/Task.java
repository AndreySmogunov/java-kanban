...
public class Task {
    ...
    public Task(String name, String description, Duration duration, LocalDateTime startTime, Object o) {
        this.name = name;
    ...
    public String toString() {
        return String.format("%d,%s,%s,%s,%s,%s,%s", id, "TASK", name, status, description, duration.toMinutes(), startTime);
    }
